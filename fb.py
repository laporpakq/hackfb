...
def banner():
    ...
    runntxt(WW+"   ..................  JANGAN SALAH GUNAKAN")
    runntxt(WW+"     ....       Riyand Pungky")
    runntxt(GL+"                   LIKE & SUBSCRIBE")
    time.sleep(1.5)
    print GG+"  √=============================================√"
    print GL+"  |••••••   NEW TOOLS HACK FACEBOOK BF.   ••••••|"
    print GG+"  √=============================================√"
    print WW+"  |            MOD BY: Riyand Pungky             |"
    print GL+"  |       Berdoa Dulu Sebelum Menggunakan       |"
    print Y+"  |             YOUTUBE: Riyand Pungky              |"
    print GL+"  |---------------------------------------------|"
    print GL+"  |       ATTACK FACEBOOK [ AF ]         |"
    print GL+"  |---------------------------------------------|"
    print GG+"  √=============================================√"
    print GL+"  |•••••••••   JANGAN SALAH GUNAKAN   •••••••••|"
    print GG+"  √=============================================√"
         ...
         `:o:``....--        ..     `:o:`
           `:+/-`  `-        ..  `-/+:`
              `-/+///..````..://+/-`
                ...
                \033[90;1mAttack Facebook\033[91;1m
             Powered by:\033[97m Riyand Pungky
      """
